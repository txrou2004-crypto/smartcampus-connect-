...
public class EnrollmentController {
 ...
 // Let students view student schedule after enrollment
    ...
    public ResponseEntity<Map<String, Object>> getStudentProgress(@PathVariable String studentId) {
        ...
        List<Enrollment> enrollments = service.getStudentSchedule(studentId);
        ...
        int totalCoursesRequired = 8;

        int progress = (int) Math.round((completed * 100.0) / totalCoursesRequired);
